...
impl JvmAccessFlags {
    ...
    pub const SYNCHRONIZED: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const NATIVE: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const INTERFACE: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: true,
    ...
    pub const SYNTHETIC: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const ANNOTATION: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const ENUM: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const BRIDGE: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const VARARGS: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
    ...
    pub const STRICT: JvmAccessFlags = JvmAccessFlags {
        is_public: false,
        is_final: false,
        is_super: false,
        is_interface: false,
...
impl BitOrAssign for JvmAccessFlags {
    fn bitor_assign(&mut self, rhs: Self) {
        ...
        self.is_synchronized |= rhs.is_synchronized;
        self.is_native |= rhs.is_native;
        self.is_bridge |= rhs.is_bridge;
        self.is_varargs |= rhs.is_varargs;
        self.is_strict |= rhs.is_strict;
...
pub enum JvmInstruction {
    ...
    Tableswitch { low: i32, high: i32, default: String, targets: Vec<String> },
    Lookupswitch { default: String, pairs: Vec<(i32, String)> },
}
...
impl JvmInstruction {
    ...
    pub fn to_byte(&self) -> u8 {
        match self {
            ...
            JvmInstruction::Iaload => 0x2E,
            JvmInstruction::Laload => 0x2F,
            JvmInstruction::Faload => 0x30,
            JvmInstruction::Daload => 0x31,
            JvmInstruction::Aaload => 0x32,
            JvmInstruction::Baload => 0x33,
            JvmInstruction::Saload => 0x34,
            JvmInstruction::Iastore => 0x4F,
            JvmInstruction::Lastore => 0x50,
            JvmInstruction::Fastore => 0x51,
            JvmInstruction::Dastore => 0x52,
            JvmInstruction::Aastore => 0x53,
            JvmInstruction::Bastore => 0x54,
            JvmInstruction::Sastore => 0x55,
            JvmInstruction::Wide => 0xC4,
            JvmInstruction::Label { .. } => 0x00, // Pseudo-instruction
            ...
            JvmInstruction::Tableswitch { .. } => 0xAA,
            JvmInstruction::Lookupswitch { .. } => 0xAB,
        }
    }
}
...
pub enum JvmStackMapFrame {
    ...
    SameLocals1StackItem { offset_delta: u16, stack: JvmVerificationType },
    SameLocals1StackItemExtended { offset_delta: u16, stack: JvmVerificationType },
    Chop { offset_delta: u16, k: u8 },
    SameExtended { offset_delta: u16 },
    Append { offset_delta: u16, locals: Vec<JvmVerificationType> },
    Full { offset_delta: u16, locals: Vec<JvmVerificationType>, stack: Vec<JvmVerificationType> },
}
...
impl JvmProgram {
    ...
    pub fn new(name: String) -> Self {
        Self {
            ...
            version: JvmVersion { major: 61, minor: 0 }, // Java 17
            source_file: None,
        }
    }
...
impl JvmConstantPool {
    ...
    pub fn add_utf8(&mut self, value: String) -> u16 {
        self.add_entry(JvmConstantPoolEntry::Utf8 { value })
    }

    pub fn add_class(&mut self, name: String) -> u16 {
        let name_index = self.add_utf8(name);
        self.add_entry(JvmConstantPoolEntry::Class { name: name_index.to_string() })
    }

    pub fn add_string(&mut self, value: String) -> u16 {
        let utf8_index = self.add_utf8(value);
        self.add_entry(JvmConstantPoolEntry::String { value: utf8_index.to_string() })
    }

    pub fn add_name_and_type(&mut self, name: String, descriptor: String) -> u16 {
        let name_index = self.add_utf8(name);
        let descriptor_index = self.add_utf8(descriptor);
        self.add_entry(JvmConstantPoolEntry::NameAndType {
            name: name_index.to_string(),
            descriptor: descriptor_index.to_string(),
        })
    }
    ...
    pub fn add_methodref(&mut self, class_name: String, name: String, descriptor: String) -> u16 {
        ...
        self.add_entry(JvmConstantPoolEntry::Methodref {
    ...
    pub fn add_fieldref(&mut self, class_name: String, name: String, descriptor: String) -> u16 {
        let class_index = self.add_class(class_name);
        let name_and_type_index = self.add_name_and_type(name, descriptor);
        self.add_entry(JvmConstantPoolEntry::Fieldref {
            class_name: class_index.to_string(),
            name: name_and_type_index.to_string(),
            descriptor: "".to_string(),
        })
...
impl JvmAccessFlags {
    ...
    pub fn from_modifiers(modifiers: &[String]) -> Self {
        ...
        for modifier in modifiers {
            match modifier.as_str() {
                ...
                "bridge" => flags.is_bridge = true,
                "varargs" => flags.is_varargs = true,
                "strict" => flags.is_strict = true,
                _ => {} // 忽略未知修饰符
            }
        }
    ...
    pub fn to_modifiers(&self) -> Vec<String> {
        ...
        if self.is_bridge {
            modifiers.push("bridge".to_string());
        }
        if self.is_varargs {
            modifiers.push("varargs".to_string());
        }
        if self.is_strict {
            modifiers.push("strict".to_string());
        }
        modifiers
    }
    ...
    pub fn to_flags(&self) -> u16 {
        ...
        if self.is_super || self.is_synchronized {
            flags |= 0x0020;
        }
        if self.is_volatile || self.is_bridge {
            flags |= 0x0040;
        }
        if self.is_transient || self.is_varargs {
            flags |= 0x0080;
        }
        if self.is_native {
            flags |= 0x0100;
